...
CLAIMS: list[dict[str, Any]] = [
    {"claim_id": "image-forward-model", "chapter": "07_synthetic_data", "anchor": "forward-model", "claim": "A particle image is modeled as a rotated 3D density projected to 2D, shifted, filtered by the point-spread function or CTF, and corrupted by noise.", "source_id": "bendory2020", "locator": "pp. 62-63, Eqs. (1)-(2)", "scope": "Single-particle cryo-EM under the projection approximation."},
    {"claim_id": "fourier-slice-theorem", "chapter": "03_fourier", "anchor": "fourier-slice-theorem", "claim": "The 2D Fourier transform of a projection is a central plane through the 3D Fourier transform of the object.", "source_id": "sigworth2016", "locator": "p. 59", "scope": "Projection approximation; Ewald-sphere curvature is neglected."},
    {"claim_id": "ctf-single-image-zero", "chapter": "03_fourier", "anchor": "ctf", "claim": "Information at a CTF zero cannot be recovered from that image alone; multiple defocus groups provide complementary frequency coverage.", "source_id": "sigworth2016", "locator": "p. 60", "scope": "Idealized single-image transfer; recovery relies on other observations and regularization."},
    {"claim_id": "ctf-phase-flipping", "chapter": "03_fourier", "anchor": "ctf", "claim": "Phase flipping multiplies Fourier coefficients by sign(CTF), correcting sign inversions but not restoring attenuated amplitudes.", "source_id": "bendory2020", "locator": "p. 69, Eqs. (16)-(17)", "scope": "A basic CTF correction, not Wiener amplitude correction."},
    {"claim_id": "ctf-model", "chapter": "07_synthetic_data", "anchor": "ctf", "claim": "The CTF phase depends on wavelength, defocus, spherical aberration, spatial frequency, and amplitude or phase contrast terms.", "source_id": "singer2020", "locator": "pp. 172-174", "scope": "Conventional weak-phase, thin-specimen CTF model."},
    {"claim_id": "dft-dc", "chapter": "03_fourier", "anchor": "dft", "claim": "For the unnormalized forward DFT, the zero-frequency coefficient equals the sum of image samples.", "source_id": "szeliski2022", "locator": "Ch. 3.4, pp. 143-146", "scope": "Normalization conventions change the scale, not the zero-frequency interpretation."},
    {"claim_id": "convolution-theorem", "chapter": "03_fourier", "anchor": "convolution", "claim": "Spatial convolution corresponds to multiplication in the Fourier domain.", "source_id": "szeliski2022", "locator": "Ch. 3.2, p. 122", "scope": "Boundary assumptions distinguish circular from linear discrete convolution."},
    {"claim_id": "nyquist-limit", "chapter": "01_image_basics", "anchor": "sampling", "claim": "The Nyquist frequency is one half-cycle per sample, so a pixel size a implies an ideal sampling limit of resolution 2a.", "source_id": "szeliski2022", "locator": "Ch. 2.3.1, p. 84", "scope": "A sampling bound, not a guarantee of achieved experimental resolution."},
    {"claim_id": "padding-boundaries", "chapter": "02_filter_segment", "anchor": "filtering", "claim": "Padding choice changes filter behavior at image boundaries and can create edge artifacts.", "source_id": "szeliski2022", "locator": "Ch. 3.2, pp. 123-124", "scope": "Finite digital images."},
    {"claim_id": "separable-filter-cost", "chapter": "02_filter_segment", "anchor": "filtering", "claim": "A separable K by K filter reduces per-pixel work from order K squared to order 2K.", "source_id": "szeliski2022", "locator": "Ch. 3.2, pp. 124-125", "scope": "Exactly separable kernels; low-rank approximations have approximation error."},
    {"claim_id": "dog-picking-bias", "chapter": "02_filter_segment", "anchor": "particle-picking", "claim": "Difference-of-Gaussians can provide a low-bias generic particle-picking template, whereas detailed references can introduce model bias.", "source_id": "sigworth2016", "locator": "p. 62", "scope": "A teaching baseline, not a claim that DoG is universally optimal."},
    {"claim_id": "wavelet-perfect-reconstruction", "chapter": "04_wavelet", "anchor": "dwt-perfect-reconstruction", "claim": "A matched analysis and synthesis discrete wavelet filter bank can reconstruct its input exactly up to numerical precision.", "source_id": "szeliski2022", "locator": "Ch. 3.5, pp. 159-163", "scope": "Compatible boundary mode and complete coefficient set are required."},
    {"claim_id": "spa-low-snr", "chapter": "05_background", "anchor": "low-dose-snr", "claim": "Low dose and weak contrast make single-particle cryo-EM images extremely noisy, so information is recovered statistically across many particles.", "source_id": "bendory2020", "locator": "pp. 60-63", "scope": "Single-particle cryo-EM."},
    {"claim_id": "ded-movies", "chapter": "05_image_formation", "anchor": "detectors", "claim": "Direct electron detectors enabled dose-fractionated movies and computational correction of beam-induced motion.", "source_id": "mie2016-ch01", "locator": "pp. 1-13", "scope": "Historical and practical detector context as of 2016."},
    {"claim_id": "motion-translation-limit", "chapter": "06_workflow", "anchor": "motion-correction", "claim": "The compared movie-alignment methods model in-plane translations and do not fully model rotation or out-of-plane motion.", "source_id": "mie2016-ch05", "locator": "pp. 103-122", "scope": "Methods reviewed in the 2016 chapter."},
    {"claim_id": "workflow-stages", "chapter": "06_workflow", "anchor": "workflow", "claim": "The SPA workflow separates micrograph-level motion, CTF, and picking steps from particle-level classification and reconstruction.", "source_id": "bendory2020", "locator": "pp. 60-61, Fig. 4", "scope": "Conceptual workflow; software packages may order or combine stages differently."},
    {"claim_id": "hard-soft-assignment", "chapter": "06_reconstruction_validation", "anchor": "soft-assignment", "claim": "Refinement may use hard best-match assignments or soft likelihood-based weights over orientations and shifts.", "source_id": "bendory2020", "locator": "pp. 64-66", "scope": "Conceptual distinction; implementations add priors and regularization."},
    {"claim_id": "ml-latent-marginalization", "chapter": "06_reconstruction_validation", "anchor": "soft-assignment", "claim": "Maximum-likelihood refinement marginalizes nuisance variables such as orientation and translation rather than estimating a single fixed value first.", "source_id": "mie2010-ch10", "locator": "pp. 263-294", "scope": "Likelihood-based cryo-EM image processing."},
    {"claim_id": "gold-standard-halves", "chapter": "06_reconstruction_validation", "anchor": "validation", "claim": "Gold-standard refinement keeps two independently refined half-sets to reduce overfitting and assesses agreement with FSC.", "source_id": "mie2016-ch06", "locator": "pp. 129-131", "scope": "Independence must be preserved through refinement."},
    {"claim_id": "fsc-mask-caveat", "chapter": "06_reconstruction_validation", "anchor": "validation", "claim": "Masks can inflate FSC, so map validation must test masking and high-resolution noise behavior.", "source_id": "mie2016-ch09", "locator": "pp. 239-245", "scope": "Half-map resolution validation."},
    {"claim_id": "orientation-bias", "chapter": "06_reconstruction_validation", "anchor": "fourier-coverage", "claim": "Preferred orientations leave anisotropic Fourier coverage and therefore anisotropic resolution.", "source_id": "sigworth2016", "locator": "pp. 59-60", "scope": "Projection data with nonuniform viewing directions."},
